...
: ${AMENT_CURRENT_PREFIX:="/home/ljq/so101_ws/install/so101_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/so101_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/so101_description/environment/path.sh"
